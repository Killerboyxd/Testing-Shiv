...
class Userbot(Client):
    ...
    async def start(self):
        ...
        if config.STRING1:
            ...
            try:
                await self.one.join_chat("https://t.me/ll_SABKA_BHAI_KILLER_ll")
        ...
        if config.STRING2:
            ...
            try:
                await self.two.join_chat("https://t.me/ll_SABKA_BHAI_KILLER_ll")
                await self.two.join_chat("https://t.me/do_dil_ek_jaan143")
        ...
        if config.STRING3:
            ...
            try:
                await self.three.join_chat("https://t.me/ll_SABKA_BHAI_KILLER_ll")
                await self.three.join_chat("https://t.me/do_dil_ek_jaan143")
        ...
        if config.STRING4:
            ...
            try:
                await self.four.join_chat("https://t.me/ll_SABKA_BHAI_KILLER_ll")
                await self.four.join_chat("https://t.me/do_dil_ek_jaan143")
        ...
        if config.STRING5:
            ...
            try:
                await self.five.join_chat("https://t.me/ll_SABKA_BHAI_KILLER_ll")
                await self.five.join_chat("https://t.me/do_dil_ek_jaan143")
